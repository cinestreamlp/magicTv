...
public class SyncUtils {
    ...
    public static final String ACCOUNT_TYPE = "com.allreplay.magictv.account";

    public static void setUpPeriodicSync(Context context, String inputId) {
        Account account = MagiTvAccountService.getAccount(ACCOUNT_TYPE);
    ...
    public static void requestSync(String inputId, boolean currentProgramOnly) {
        ...
        ContentResolver.requestSync(MagiTvAccountService.getAccount(ACCOUNT_TYPE), CONTENT_AUTHORITY,
                bundle);
    }
}
