 ...
 */
public class MagiTvAccountService extends Service {
    private static final String TAG = "MagiTvAccountService";
    private DummyAuthenticator mAuthenticator;
    public static final String ACCOUNT_NAME = "MagiTvAccount";
